...
const PAGES = [
  ...
  { id: 'potable_water', de: 'Trinkwasser', href: '/maerkte' },
  { id: 'hvac', de: 'Klima & Kühlung', href: '/maerkte' },
  { id: 'industrial', de: 'Industrieanlagen', href: '/maerkte' },
  { id: 'shipbuilding', de: 'Schiffbau', href: '/maerkte' },
  { id: 'agriculture', de: 'Landwirtschaft', href: '/maerkte' },
  { id: 'solutions', de: 'Alle Lösungen', href: '/loesungen' },
  { id: 'high_rise', de: 'Hochhausbau', href: '/loesungen' },
  { id: 'hospitals', de: 'Krankenhäuser', href: '/loesungen' },
  { id: 'hotels', de: 'Hotels & Resorts', href: '/loesungen' },
  { id: 'datacenters', de: 'Rechenzentren', href: '/loesungen' },
  { id: 'prefab', de: 'Vorfertigung', href: '/loesungen' },
  { id: 'academy', de: 'Academy Übersicht', href: '/academy' },
  { id: 'wissen', de: 'Academy', href: '/academy' },
  { id: 'trainings', de: 'Schulungen', href: '/academy' },
  { id: 'webinars', de: 'Webinare', href: '/academy' },

...
| **P6** | M11 (B/C) | Rohrschelle: Gummieinlage entfernen (Foto zeigt grüne Innenflächen; einziger Beleg), Sechskant-Stahlbuchse statt Mutterblock | `products/pipe-clamps/parts.js` | 1 | **nur zur Hälfte erledigt 25.08.** — Einlage und Rillen ja, die Verbindungsgestalt (Kreuzschlitz, U-Scheiben, Laschen, Vierkantmuttern) nicht. Nachgeholt **01.09.** zusammen mit sieben Lage- und Massenfehlern, die keine Prüfung sah: M13–M19, Bericht `pruefung/rohrschelle-instandsetzung.md` |

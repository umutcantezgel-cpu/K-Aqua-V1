/* K-Aqua 3D · T-Stück 90° mit Innengewinde — gebündeltes ES-Modul.
   Erzeugt, nicht handgepflegt. Produkt-ID transition-fittings/tee-90-female-thread.
   Maße in Millimetern; die Umrechnung auf Meter macht der Viewer. */

import * as THREE from 'three';
import {
  D2R, DRAFT, ISO, SEG_FINE, SEG_INT, SEG_VIS, branchJoin, buildProfile, capFromProfile, createAssembly, fusionDepth, hexPrism, materials, mergeGeometries, mirrorProfile, revolve, threadProfile,
...
/* == tee-90-female-thread/params.js ==================================== */
/* K-Aqua T-Stück 90° mit Innengewinde — Parametrik.
...
/* == tee-90-female-thread/parts.js ===================================== */
/* K-Aqua T-Stück 90° mit Innengewinde — Konturen.

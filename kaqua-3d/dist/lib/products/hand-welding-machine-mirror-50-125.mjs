/* K-Aqua 3D · Heizspiegel 50–125 — gebündeltes ES-Modul.
   Erzeugt, nicht handgepflegt. Produkt-ID tools/hand-welding-machine-mirror-50-125.
   Maße in Millimetern; die Umrechnung auf Meter macht der Viewer. */

import * as THREE from 'three';
import {
  SEG_FINE, SEG_INT, SEG_VIS, buildProfile, capFromProfile, createAssembly, loft, materials, mergeGeometries, revolve, roundedPad,
...
/* == hand-welding-machine-mirror-50-125/data.js ======================== */
/* K-Aqua Heizspiegel 50–125 — PROTOTYP.
   QUELLE: S. 114: nur Code AQ991125, Pack 1. Gestalt nach dem
   Katalogrender (Kontaktbogen s114-06); alle Maße ASSUMPTION. */
export const DATA_STATUS = 'prototyp';
export const ARTICLES = [ { key: 'set', code: 'AQ991125', pack: 1 } ];
export const SIZES = ['set'];
export const DIMENSION_KEY = {};
export function article() { return ARTICLES[0]; }


/* == hand-welding-machine-mirror-50-125/params.js ====================== */
...
/* == hand-welding-machine-mirror-50-125/parts.js ======================= */
...
/* == hand-welding-machine-mirror-50-125/index.js ======================= */

/* K-Aqua 3D · Überbogen-Rohr — gebündeltes ES-Modul.
   Erzeugt, nicht handgepflegt. Produkt-ID fittings/cross-over-pipe.
   Maße in Millimetern; die Umrechnung auf Meter macht der Viewer. */

import * as THREE from 'three';
import {
  D2R, DRAFT, SEG_INT, SEG_VIS, bridgePath, circleLoop, createAssembly, fusionDepth, materials, mergeGeometries, meshVolume, polygonCap, socketOD, sweepPath,
...
/* == cross-over-pipe/params.js ========================================= */
/* K-Aqua Überbogen-Rohr — Parametrik.
...
/* == cross-over-pipe/parts.js ========================================== */
/* K-Aqua Überbogen-Rohr — Kontur.
...
/* == cross-over-pipe/index.js ========================================== */
/* K-Aqua Überbogen-Rohr — Produktpaket.
...
const product = {
  ...
  build(size, variant, clipPlane) {
    return buildUeberbogen({
      ...
      article,
      dimensionKey: DIMENSION_KEY,
      exportName: 'K-Aqua_Ueberbogen_Rohr',
      teilName: 'Ueberbogen_Rohr',
      teilLabel: 'Überbogen-Rohr (PP-R)',
      seed: 167,
      messungen: (P, a, { imBand }) => [
        ...
        { key: 'd', label: DIMENSION_KEY.d,
          ...
          ist: () => {
            ...
            return g.n ? Math.round(('rohr' === 'rohr' ? 2 * g.max : 2 * g.min) * 100) / 100 : NaN;
          } },
      ],

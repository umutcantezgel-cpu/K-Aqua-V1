/* K-Aqua 3D · K-Fiber UV Rohr PP-R SDR 7,4 — gebündeltes ES-Modul.
   Erzeugt, nicht handgepflegt. Produkt-ID pipes/k-fiber-uv-pipe-pp-r-sdr-7-4.
...
/* == k-fiber-uv-pipe-pp-r-sdr-74/data.js =============================== */
...
/* == k-fiber-uv-pipe-pp-r-sdr-74/params.js ============================= */
...
const product = {
  ...
  build(size, variant, clipPlane) {
    const P = params(size);
    const matKeys = [...new Set([...LAYERS.map((l) => l.key), ...STRIPES.map((s) => s.key), 'pprPrint'])];
    ...
    /* Aufdruck statt Prägung — Rohre werden extrudiert. Auf der schwarzen
       UV-Schutzschicht steht die Kennzeichnung besonders deutlich. */
    A.part('print', {
      name: 'Aufdruck',

...
import {
  D2R, SEG_INT, SEG_VIS, buildProfile, capFromProfile, createAssembly, hexPrism, materials, mergeGeometries, plateWithHoles, polygonCap, revolve, ringGrooves, roundedPad, tubeLayers,

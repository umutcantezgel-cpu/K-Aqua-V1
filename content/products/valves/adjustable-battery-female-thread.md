...
article_codes: ["AQ64ARCG20","AQ64ARCG25"]
---

# Adjustable Battery (Female Thread)

Adjustable-length PP-R distribution manifold with female thread outlets - variable centre distance between outlets.

## Article Table

| Code        | d (mm) | Rp  | Min L (mm) | Max L (mm) | Pack |
|-------------|--------|-----|-----------|-----------|------|
| AQ64ARCG20  | 20     | ½"  | -         | -         | 1    |
| AQ64ARCG25  | 25     | ½"  | -         | -         | 1    |

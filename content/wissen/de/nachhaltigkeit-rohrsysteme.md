...
title: "Nachhaltigkeit in der modernen Rohrleitungstechnik"
...
tags: ["Nachhaltigkeit", "CO2", "Green Building", "Recycling"]
---

Der Bausektor ist für einen erheblichen Teil der weltweiten CO2-Emissionen verantwortlich. Dementsprechend wächst der Druck auf Architekten und Planer, nachhaltigere und emissionsärmere Materialien einzusetzen. Bei der Gebäudetechnik (TGA) spielen die verwendeten Rohrsysteme eine oft unterschätzte, aber signifikante Rolle für die Ökobilanz eines Gebäudes.

## Die CO2-Bilanz von Kunststoff vs. Metall

Viele Planer gehen instinktiv davon aus, dass metallische Rohre (wie Kupfer oder Stahl) "natürlicher" und damit umweltfreundlicher seien als Kunststoffe. Eine ganzheitliche Ökobilanz-Betrachtung (Life Cycle Assessment - LCA) zeichnet jedoch ein völlig anderes Bild.

PP-RCT schlägt Metall in 3 zentralen Nachhaltigkeits-Kategorien:
...
Der Einsatz von nachweislich nachhaltigen Rohrsystemen zahlt direkt in Punktekataloge von Zertifizierungen wie LEED (Leadership in Energy and Environmental Design) oder BREEAM ein. 

Darüber hinaus trägt die exzellente thermische Isolationsfähigkeit von PP-RCT (insbesondere bei unseren [mehrschichtigen Faserverbundrohren](/de/produkte/pipes)) dazu bei, Energieverluste bei der Zirkulation von Warmwasser oder Kühlmedien zu minimieren. Das verbessert die Energieeffizienz des gesamten Gebäudes.

Setzen Sie ein Zeichen für die Zukunft. Planen Sie nachhaltig mit K-Aqua.

...
export const altbausanierungFlexibilitaet: NewsPost = {
  ...
  content: () => (
    <div className="flex flex-col gap-24 py-12">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-card-border bg-card p-8 md:p-16 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 relative z-10">
            <SectionHead
              ...
              lead="Die Sanierung historischer Gebäude oder alter Mehrfamilienhäuser ist oft ein logistischer Albtraum. Enge, verwinkelte Versorgungsschächte und der laufende Betrieb fordern Installateuren alles ab. Wer hier schwere C-Stahlrohre über Treppenhäuser schleppt und im Schacht mit offenem Feuer lötet, verliert Zeit und riskiert Brände. K Aqua PP-R bietet die leichte, flexible und absolut brandsichere Alternative für die moderne Strangsanierung."
            />
          </div>
      ...
      {/* Stagger: Argumente für PP-R im Altbau */}
      <Reveal>
        <SectionHead
          ...
          <Stagger
            items={[
              ...
              },
              {
                ...
                description: "Ein 4-Meter-Stahlrohr im vierten Stock ohne Aufzug zu manövrieren, ist ein Kraftakt. PP-R Rohre wiegen nur einen Bruchteil davon, was die körperliche Belastung der Installateure drastisch senkt und den Baufortschritt beschleunigt."
              },
              {
            ...
            items={[
              {
                ...
                description: "Nachdem alte Bleirohre oder stark korrodierte verzinkte Stahlrohre entfernt wurden, offenbaren Schächte oft unregelmäßige Maße. Hier spielt PP-R seine Flexibilität bei der Neuplanung der Trassen voll aus.",
                icon: <Wrench className="w-8 h-8 text-primary" />
              },
              {
                title: "2. Die Steigleitungs-Erneuerung",
      ...
      <Reveal>
        ...
        <DeepFAQ
          items={[
            {
              q: "Darf ich PP-R mit alten Kupferleitungen mischen?",
              a: "Ja, absolut. Im Gegensatz zur Fließregel bei unterschiedlichen Metallen (Kupfer darf in Fließrichtung nicht vor verzinktem Stahl liegen) ist PP-R völlig inert. Mit K Aqua Übergangsfittings aus entzinkungsfreiem Messing ist die Anbindung problemlos möglich."
            },
            {
              q: "Was passiert mit Druckstößen im alten Netz?",
              a: "Alte Netze neigen oft zu Wasserschlägen, z.B. durch schnell schließende Armaturen. PP-R absorbiert und dämpft diese Druckstöße besser als Metall, was alte, empfindliche Armaturen im Bestandsnetz schont."
            },
            {
              q: "Wie überbrücke ich alte, dicke Stahlrohre?",
              a: "K Aqua bietet ein umfangreiches Sortiment an Gewindeübergängen und Flanschverbindungen. So können Sie von großen Stahl-Verteilern direkt auf das moderne PP-R System reduzieren und sicher weiterbauen."
            }
          ]}
        />
      </Reveal>

      {/* StatBand: Sanierungs-Fakten */}
      <Reveal>
        <div className="mt-8">
          <StatBand
            cols={3}
            stats={[
              ...
              { n: "100", u: "%", l: "Kompatibel mit allen gängigen Metallsystemen über unsere Spezial-Fittings." }
            ]}
          />
        </div>
      </Reveal>

      {/* CTABand: Sanierungs-Support */}
      <Reveal>
        <CTABand

        ...
        <div className="relative overflow-hidden rounded-3xl border border-card-border bg-card p-8 md:p-16 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 relative z-10">
            <SectionHead
              ...
              lead="Die intelligente Lösung für den Gebäudebestand: PP-R Rohrleitungssysteme. Die Altbausanierung mit PPR Rohrsystemen historischer Gebäude oder alter Mehrfamilienhäuser ist oft ein logistischer und technischer Albtraum. Enge, verwinkelte Versorgungsschächte und der laufende Betrieb fordern Installateuren alles ab. Wer schwere C-Stahlrohre schleppt und mit offenem Feuer lötet, verliert wertvolle Zeit. K Aqua bietet durch unerreichte Flexibilität und schnelle Verlegung die leichte und absolut brandsichere Alternative für die moderne Strangsanierung. Mit einer Dichte von nur 0,9 g/cm³ sind PP-R Rohre extrem leicht. Zudem verhindert die glatte Innenoberfläche (Rauigkeit von nur 0,007 mm) Inkrustationen und Kalkablagerungen, was die Langlebigkeit garantiert."
            />

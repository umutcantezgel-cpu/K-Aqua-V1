        ...
        <div className="relative overflow-hidden rounded-3xl border border-card-border bg-card p-8 md:p-16 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 relative z-10">
            <SectionHead
              ...
              lead="Die offene Bauweise, also das massive Aufreißen von Straßenkreuzungen, Gehwegen und asphaltierten Industrieflächen, verschlingt beim Bau von Nahwärmenetzen, Kühlwasserleitungen oder industriellen Medientrassen oftmals weit über 70% des gesamten Projektbudgets. Wenn es um Erdverlegung: Grabenloser Rohrleitungsbau & HDD (Horizontal Directional Drilling) geht, haben wir die weitaus elegantere, wirtschaftlichere und umweltschonendere Alternative. K-Aqua PP-R Systeme sind durch ihre enorme Zähigkeit, materialspezifische Flexibilität und absolute Längskraftschlüssigkeit (Zugfestigkeit durch Polyfusion) die prädestinierte Wahl für diese anspruchsvolle, unterirdische Verlegetechnik."
            />
          </div>

...
import { Droplet, AlertTriangle, Activity } from "@/components/ui/icon";
    ...
    <div className="flex flex-col gap-24 py-12">
      ...
      <Reveal>
        <div className="max-w-4xl mx-auto px-4 md:px-8 prose prose-lg dark:prose-invert text-muted-foreground">
          ...
          <p className="mb-4">
            Betrachtet man das Thema PPR Rohre vs. Mehrschichtverbundrohr (MSVR): Ein tiefgreifender Systemvergleich zeigt schnell die grundlegenden strukturellen Unterschiede (im englischsprachigen Raum "PPR Pipes vs. Multilayer Composite Pipes", auf Arabisch "أنابيب البولي بروبيلين العشوائي (PPR) مقابل الأنابيب المركبة متعددة الطبقات"). Um die Vor- und Nachteile im Detail zu verstehen, muss man die architektonische Basis der beiden Rohrsysteme betrachten. Moderne PP-R und PP-RCT Systeme zeichnen sich durch ihre herausragende chemische und thermische Widerstandsfähigkeit aus. Ein K-Aqua PPR-Rohr besteht, selbst in der faserverstärkten Variante, durchgehend aus demselben thermoplastischen Basispolymer (Polypropylen). Diese Homogenität erlaubt es, Rohr und Fitting unter Zugabe von Wärme (Polyfusion) auf molekularer Ebene unlösbar miteinander zu verschmelzen. Das Ergebnis ist ein Leitungssystem, das so wirkt, als sei es aus einem einzigen, durchgehenden Stück Kunststoff gegossen.
          </p>
          <p className="mb-4">

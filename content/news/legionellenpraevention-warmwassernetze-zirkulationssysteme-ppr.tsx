    ...
    <div className="flex flex-col gap-24 py-12">
      ...
      <Reveal>
        <CTABand>
          ...
          <Link href="/ressourcen/support" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-primary font-semibold rounded-lg hover:bg-white/90 transition-colors mt-2 w-fit">
            <ShieldCheck className="w-5 h-5" />

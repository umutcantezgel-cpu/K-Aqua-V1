    ...
    <div className="flex flex-col gap-24 py-12">
      ...
      <Reveal>
        <ParallaxHero headingLevel="h2"
          ...
          description="Maritime Einsatzbedingungen verzeihen keine Schwächen. Aggressives Salzwasser zersetzt unbehandelte Metalle innerhalb kürzester Zeit. K Aqua PPR und PPRCT Rohrsysteme sind zu 100 % seewasserresistent und bieten eine revolutionäre Alternative zu schweren CuNiFe Leitungen."
        />
      </Reveal>
      ...
      <Reveal>
        <CTABand>
          <h3 className="text-2xl md:text-3xl font-bold">Planen Sie ein Werftprojekt?</h3>
          <p className="text-inverse-foreground/80 leading-relaxed">Reduzieren Sie das Gewicht Ihres Schiffes und eliminieren Sie Korrosionsprobleme dauerhaft.</p>
          <NavLink href="/kontakt" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-primary font-semibold rounded-lg hover:bg-white/90 transition-colors mt-2">
            Marine Spezialisten kontaktieren
          </NavLink>
        </CTABand>
      </Reveal>

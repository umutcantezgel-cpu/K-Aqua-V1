  ...
  content: (
    <div className="flex flex-col gap-24 py-12">
      ...
      <Reveal>
        ...
        />
        <DeepMatrix
          head={["Merkmal", "2D Planung (CAD)", "3D-BIM (z.B. Revit)"]}
          rows={[
        ...
        <div className="mt-8">
          <Stagger className="flex flex-col gap-6">
            ...
            <Reveal key="2">
              <div className="bg-card border border-card-border rounded-2xl p-6 h-full flex flex-col justify-between">
                <div>
                  <h3 className="text-xl font-bold mb-2 text-foreground">2. Intelligentes Auto Routing</h3>
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Dank der hinterlegten Routingpräferenzen wählt die BIMsoftware beim Zeichnen eines Bogens oder Abzweigs automatisch das geometrisch korrekte K Aqua Fitting aus dem Katalog aus.
                  </p>
                </div>
              </div>
            </Reveal>
            <Reveal key="3">
              <div className="bg-card border border-card-border rounded-2xl p-6 h-full flex flex-col justify-between">
                <div>
                  <h3 className="text-xl font-bold mb-2 text-foreground">3. Übergang zur Vorfertigung (Prefab)</h3>
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Ist das Rohrnetz fehlerfrei modelliert, können direkt Isometrien und Spool Zeichnungen exportiert werden. Diese dienen der Werkstatt als exakte Vorlage für die millimetergenaue Vorfertigung.
                  </p>
                </div>
              </div>
            </Reveal>

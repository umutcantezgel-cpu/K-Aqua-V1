  ...
  content: (
    <div className="flex flex-col gap-24 py-12">
      ...
      <section className="py-12 prose prose-lg dark:prose-invert max-w-none text-muted-foreground">
        ...
        <p>
          Wasserschäden in komplexen Gebäudestrukturen wie Krankenhäusern, Rechenzentren, Hotels und industriellen Produktionsanlagen gehören zu den am meisten gefürchteten Risiken in der technischen Gebäudeausrüstung (TGA). Die direkten Kosten durch Gebäudeschäden, Schimmelbildung und Sanierung sind enorm, doch die indirekten Kosten durch Betriebsausfälle, Nutzungsausfall und juristische Auseinandersetzungen übersteigen diese oft um ein Vielfaches. Eine effektive Wasserschaden-Prävention durch Leckageerkennung ist hierbei unerlässlich. In diesem hochsensiblen Umfeld bietet das K-Aqua PP-R (Polypropylen-Random-Copolymer) Rohrsystem eine revolutionäre Antwort auf die inhärenten Schwächen traditioneller, metallischer Rohrnetze. Die Kombination aus molekularer Materialhomogenität und modernster Sensorik-Integration setzt neue Standards für die Gebäudesicherheit.
        </p>

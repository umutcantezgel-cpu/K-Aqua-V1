    ...
    <div className="flex flex-col gap-24 py-12">
      ...
      <Reveal>
        <div className="max-w-4xl mx-auto px-4 md:px-8 prose prose-lg dark:prose-invert text-muted-foreground">
          ...
          <p className="mb-4">
            Genau diesen Moment bezeichnet man als <span className="font-semibold">Unterschreitung des Taupunkts</span>. Um dies zu verhindern, müssen Kaltwasserleitungen mit einer extrem diffusionsdichten Isolierung (z. B. aus Kautschuk) ummantelt werden, die das Rohr vollständig von der Raumluft abschirmt. Durch den Einsatz moderner Klimaanlagen, Chiller & Kaltwassersätze mit K-Aqua PPRCT lässt sich die Kondensationsproblematik physikalisch deutlich entschärfen und die Anlagensicherheit auf ein neues Niveau heben.
          </p>

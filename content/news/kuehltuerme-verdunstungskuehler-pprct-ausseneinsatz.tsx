  ...
  content: (
    <div className="flex flex-col gap-24 py-12">
      ...
      <section className="py-12 prose prose-lg dark:prose-invert max-w-none text-muted-foreground">
        ...
        <p>
          Offene Verdunstungskühlanlagen sind berüchtigt dafür, ideale Brutstätten für Legionellen zu sein. Um tödliche Ausbrüche der Legionärskrankheit (wie den VDI 2047-2 Richtlinien entsprechend) zu verhindern, wird das Kühlwasser extrem aggressiv mit Bioziden (Ozon, Chlor, Chlordioxid) schockdesinfiziert. Diese hoch oxidative Substanzen fressen metallische Leitungen buchstäblich von innen auf, insbesondere im Bereich der Phasengrenzen, wenn das System zeitweise leerläuft. K-Aqua PP-RCT ist gegen diese massiven chemischen Angriffe nahezu immun. Die Kunststoffmatrix wird von den in Kühltürmen üblichen Biozidkonzentrationen nicht angegriffen, oxidiert nicht und bildet keine rauen Oberflächen, an denen sich neue Biofilme festsetzen könnten. Mit der Wahl von K-Aqua PP-RCT transformieren Sie die anfälligste Komponente des Kühlsystems, die Rohrleitung auf dem Dach, in die langlebigste und sicherste.
        </p>
      </section>

    ...
    <div className="flex flex-col gap-24 py-12">
      ...
      <Reveal>
        <div className="max-w-4xl mx-auto px-4 md:px-8 prose prose-lg dark:prose-invert text-muted-foreground">
          ...
          <p className="mb-4">
            Die Wahl des richtigen Isolationsmaterials für Rohrleitungssysteme ist eine der wichtigsten Entscheidungen in der modernen Technischen Gebäudeausrüstung (TGA). Betrachtet man die Rohrdämmung im Vergleich, wird deutlich, dass die Entscheidung für PIR, PUR und EPS bei PPR-Rohren erhebliche Auswirkungen auf die Energieeffizienz und Langlebigkeit hat (international auch relevant unter Themen wie "Pipe Insulation Comparison: PIR, PUR and EPS" oder arabisch "مقارنة عزل الأنابيب: PIR، وPUR، وEPS"). PP-R (Polypropylen Random Copolymer) und PP-RCT (Polypropylen Random Copolymer mit modifizierter Kristallstruktur und erhöhter Temperaturbeständigkeit) bieten von Haus aus hervorragende Dämmeigenschaften. Dennoch ist eine zusätzliche fachgerechte Isolierung unumgänglich, um den strengen gesetzlichen Anforderungen gerecht zu werden. Obwohl Polypropylen (PPR) aufgrund seiner molekularen Struktur bereits hervorragende thermodynamische Eigenschaften und eine weitaus geringere Wärmeleitfähigkeit als metallische Rohre (wie Kupfer oder Stahl) aufweist, unterliegen auch Kunststoffrohrnetze strengen gesetzlichen Vorgaben, wie dem Gebäudeenergiegesetz (GEG) in Deutschland. 
          </p>
          <p className="mb-4">

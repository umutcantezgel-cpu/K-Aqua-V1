    ...
    <div className="flex flex-col gap-24 py-12">
      ...
      <Reveal>
        <SectionHead
          ...
          lead="Wie viel Druck hält ein PPR Rohr bei industriellen Standardbedingungen (20 °C Umgebungstemperatur, 50 Jahre Lebensdauer) stand?"
        />
        <DeepMatrix
          data={[
        ...
        <Stagger
          items={[
            ...
            },
            {
              ...
              description: "Ein PPR Rohr wiegt nur einen Bruchteil eines Stahlrohres. Die Installation unter Hallendecken geht wesentlich schneller und mit weniger Personal vonstatten."
            },
            {

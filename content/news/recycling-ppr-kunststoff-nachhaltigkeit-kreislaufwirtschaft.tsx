...
export const recyclingPpr: NewsPost = {
  ...
  title: {
    de: "Recycling von PPR & Nachhaltigkeit",
    en: "Recycling of PPR & Sustainability",
    ar: "إعادة تدوير PPR والاستدامة"
  },
  date: "2024-09-20",
  teaser: {
    de: "Kunststoff und Umweltschutz schließen sich nicht aus. Erfahren Sie, wie K Aqua PPR und PPRCT Rohrsysteme als sortenreiner Thermoplast zu 100 % recycelbar sind und einen wesentlichen Beitrag zur nachhaltigen Kreislaufwirtschaft im Gebäudebau leisten.",
  ...
  tags: ["Recycling", "Nachhaltigkeit", "Kreislaufwirtschaft", "PPR", "Umweltschutz", "Thermoplast", "Rohrsysteme"],
    ...
    <div className="flex flex-col gap-24 py-12">
              ...
              items={[
                {
                  year: "Phase 1",
                  title: "Produktion",
                  description: "K Aqua Rohre werden aus hochwertigem, reinem PPR Granulat ohne toxische Weichmacher ressourcenschonend extrudiert."
                },
                {
                  year: "Phase 2",
      ...
      <Reveal>
        <div className="mt-8">
          <StatBand
            cols={3}
            stats={[
              { n: "100", u: "%", l: "Recycelbarkeit des homogenen PPR Materials." },
      ...
      <Reveal>
        <DeepFAQ
          items={[
            {
              q: "Was passiert mit den Rohrverschnittresten auf der Baustelle?",
            ...
            {
              q: "Darf PPR in den normalen Bauschutt?",
            ...
            },
            {
              ...
              a: "Die Herstellung und Verarbeitung von PPR erfordert deutlich niedrigere Temperaturen als die Verhüttung von Stahl oder Kupfer. Dies führt zu massiven Einsparungen an Energie und CO2 Emissionen bei der Produktion."
            }
          ]}
        />
      </Reveal>
      ...
      <Reveal>
        <CTABand
          ...
          subtitle="Bauen Sie nach DGNB, LEED oder BREEAM? Fordern Sie unsere EPDdokumente an, um die Ökobilanz Ihres Gebäudezertifikats zu maximieren."

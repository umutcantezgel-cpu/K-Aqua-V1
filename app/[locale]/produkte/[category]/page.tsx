                    ...
                    <>
                      ...
                      <div className="p-6 flex flex-col flex-1">
                        ...
                        <div className="mt-auto flex items-center text-sm font-semibold text-primary gap-1 group-hover:gap-2 transition-all w-full" aria-hidden="true">
                          {/* `min-w-0`: Ohne das behält ein Flex-Kind seine
                              Inhaltsbreite und läuft über, statt zu kürzen. */}
                          <span className="truncate min-w-0">{tc("viewDetails")}: {localizedTitle}</span>

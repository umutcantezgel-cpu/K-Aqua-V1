# Befund fr-SN — 426 offene Einträge

Jede Zeile ist ein Wert, der in `messages/fr-SN.json` noch fehlt,
...
- `productNames.accessories_plug`  Sichere PP-R Rohrstopfen für Leitungen
- `productNames.fittings_cap`  Zuverlässige PP-R Endkappe für Rohre
...
- `resources.bim.timeline.items.0.year`  Phase 1
- `resources.bim.timeline.items.1.year`  Phase 2
- `resources.bim.timeline.items.2.year`  Phase 3
- `resources.bim.timeline.items.3.year`  Phase 4
- `resources.bim.timeline.items.4.year`  Phase 5

# Befund sl — 520 offene Einträge

Jede Zeile ist ein Wert, der in `messages/sl.json` noch fehlt,
...
- `nav.mega.academyDesc`  Schulungen & Zertifikate
- `nav.mega.allProducts`  Alle Produkte
...
- `nav.mega.careerDesc`  Offene Stellen & Kultur
- `nav.mega.co2Desc`  Umweltbilanz kalkulieren
- `nav.mega.company`  Das Unternehmen
- `nav.mega.companyDesc`  Mission, Vision & Historie
- `nav.mega.contactDesc` [fehlt] Sprechen Sie mit unserem Fachteam
- `nav.mega.digitalTools`  Digitale Tools
- `nav.mega.downloads` [fehlt] Download-Center
- `nav.mega.downloadsDesc` [fehlt] Kataloge, Datenblätter und Zertifikate als PDF
- `nav.mega.finderDesc`  Das richtige System konfigurieren
- `nav.mega.globalFootprint`  Globaler Fußabdruck
- `nav.mega.globalMarkets`  Globale Märkte
- `nav.mega.homeSr`  K-Aqua Startseite
- `nav.mega.imprintDesc` [fehlt] Rechtliche Unternehmensinformationen
- `nav.mega.marketsDesc`  Zertifizierte Regionen
- `nav.mega.newsDesc`  Aktuelle Pressemitteilungen
- `nav.mega.newsPress`  News & Presse
- `nav.mega.partnersDesc`  Werden Sie lokaler Partner
- `nav.mega.pipeSystems`  Rohrsysteme
...
- `nav.mega.refDesc`  Erfolgreiche Installationen
- `nav.mega.refProjects`  Referenzprojekte
- `nav.mega.serviceDesc`  Planungsunterstützung
- `nav.mega.sitemap`  Sitemap
- `nav.mega.sitemapDesc`  Strukturübersicht
- `nav.mega.solutionsDesc`  Industriespezifische Applikationen
...
- `nav.mega.trustDesc`  Downloads & Zertifizierungen

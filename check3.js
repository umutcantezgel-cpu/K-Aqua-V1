...
console.log('Missing in homedeep:', missing.filter(k => k.startsWith('homedeep.')));
console.log('Missing in legal:', missing.filter(k => k.startsWith('legal.')));
console.log('Missing in cookieConsent:', missing.filter(k => k.startsWith('cookieConsent.')));

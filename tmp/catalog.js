...
exports.CATALOG = exports.CATALOG_COL_LABELS = void 0;
exports.getCatalogTotalArticleCount = getCatalogTotalArticleCount;
exports.resolveCatalogHead = resolveCatalogHead;
function getCatalogTotalArticleCount() {
    return exports.CATALOG.reduce(function (sum, cat) { return sum + cat.items.length; }, 0);
}
exports.CATALOG_COL_LABELS = {
    "de": {
        "weight": "Gewicht (kg)",
...
function resolveCatalogHead(head, locale) {
    var L = exports.CATALOG_COL_LABELS[locale] || exports.CATALOG_COL_LABELS.en;
    return head.map(function (h) { return (h[0] === '#' ? (L[h.slice(1)] || h) : h); });
}
exports.CATALOG = [
    {
        id: "pipes",

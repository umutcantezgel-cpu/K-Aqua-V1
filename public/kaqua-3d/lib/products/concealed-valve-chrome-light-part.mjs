/* K-Aqua 3D · Unterputzventil-Oberteil (leichte Ausführung) — gebündeltes ES-Modul.
   Erzeugt, nicht handgepflegt. Produkt-ID valves/concealed-valve-chrome-light-part.
...
/* == concealed-valve-chrome-light-part/data.js ========================= */
/* K-Aqua Unterputzventil-Oberteil (leichte Ausführung) — PROTOTYP.

   QUELLE: Druckkatalog S. 106. Die Tabelle führt NUR Code, G ¾",
   kg 0.21, Pack 1 — keine Maßspalten, keine Maßskizze (LOOP-STATUS
...
/* == concealed-valve-chrome-light-part/parts.js ======================== */



/* == concealed-valve-chrome-light-part/index.js ======================== */
/* Unterputzventil-Oberteil (leichte Ausführung) — Produktpaket. PROTOTYP (data.js). */
...
const product = {
  ...
  build(size, variant, clipPlane) {
    ...
    const A = createAssembly({
      name: 'K-Aqua_UP_AQ5992', materials: ['chrome', 'brass'], seed: 193, clipPlane,
    });

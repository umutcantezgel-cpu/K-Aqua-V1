/* K-Aqua 3D · Anbohrsattel mit Außengewinde — gebündeltes ES-Modul.
   Erzeugt, nicht handgepflegt. Produkt-ID weld-in-saddles/weld-in-saddle-male-thread.
...
/* == weld-in-saddle-male-thread/data.js ================================ */
...
/* == weld-in-saddle-male-thread/params.js ============================== */
/* K-Aqua Anbohrsattel mit Außengewinde — Parametrik.
...
/* == weld-in-saddle-male-thread/parts.js =============================== */
...
/* == weld-in-saddle-male-thread/index.js =============================== */

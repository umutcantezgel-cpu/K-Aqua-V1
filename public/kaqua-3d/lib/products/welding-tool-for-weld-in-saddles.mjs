/* K-Aqua 3D · Schweißwerkzeug für Anbohrsättel — gebündeltes ES-Modul.
   Erzeugt, nicht handgepflegt. Produkt-ID tools/welding-tool-for-weld-in-saddles.
...
/* == welding-tool-for-weld-in-saddles/data.js ========================== */
...
/* == welding-tool-for-weld-in-saddles/params.js ======================== */
...
/* == welding-tool-for-weld-in-saddles/parts.js ========================= */



/* == welding-tool-for-weld-in-saddles/index.js ========================= */
/* Schweißwerkzeug für Anbohrsättel — Produktpaket. PROTOTYP (data.js). */
...
const product = {
  ...
  build(size, variant, clipPlane) {
    ...
    const A = createAssembly({
      name: 'K-Aqua_welding-tool-for-weld-in-saddles'.replace(/-/g, '_'), materials: ['steel'], seed: 199, clipPlane,
    });
    const dorn = buildDorn(P);
    const buchse = buildBuchse(P, { sattel: true });

/* K-Aqua 3D · Anschlussbogen 90° mit Innengewinde — gebündeltes ES-Modul.
   Erzeugt, nicht handgepflegt. Produkt-ID transition-fittings/elbow-bracket-90-female-thread.
   Maße in Millimetern; die Umrechnung auf Meter macht der Viewer. */

import * as THREE from 'three';
import {
  D2R, DRAFT, ISO, SEG_FINE, SEG_INT, SEG_VIS, bendPath, buildProfile, circleLoop, createAssembly, fusionDepth, hexPrism, materials, mergeGeometries, plateWithHoles, revolve, sweepPath, threadProfile, threadRing, threadSpec,
...
/* == elbow-bracket-90-female-thread/data.js ============================ */
...
/* == elbow-bracket-90-female-thread/params.js ========================== */
...
/* == elbow-bracket-90-female-thread/parts.js =========================== */
/* K-Aqua Anschlussbogen 90° IG — Konturen.

   Alle Teile kommen aus ../_bracket/parts.js und ../_bendthread/parts.js.
   Der Unterschied zur Wandscheibe ist die Lasche, die dieses Produkt
   NICHT hat — cfg.lug steuert sie, nicht eine eigene Kontur. */


/* == elbow-bracket-90-female-thread/index.js =========================== */

/* K-Aqua 3D · Handschweißgerät 20–63 (Set) — gebündeltes ES-Modul.
   Erzeugt, nicht handgepflegt. Produkt-ID tools/hand-welding-machine-20-63.
...
/* == hand-welding-machine-20-63/data.js ================================ */
/* K-Aqua Handschweißgerät 20–63 (Set) — PROTOTYP.
   QUELLE: S. 114: nur Code AQ98063, Pack 1. Gestalt nach dem
   Katalogrender (Kontaktbogen s114-04/05); alle Maße ASSUMPTION. */
export const DATA_STATUS = 'prototyp';
export const ARTICLES = [ { key: 'set', code: 'AQ98063', pack: 1 } ];
export const SIZES = ['set'];
export const DIMENSION_KEY = {};
export function article() { return ARTICLES[0]; }


/* == hand-welding-machine-20-63/params.js ============================== */
...
/* == hand-welding-machine-20-63/parts.js =============================== */
...
/* == hand-welding-machine-20-63/index.js =============================== */
/* Handschweißgerät 20–63 (Set) — Produktpaket. PROTOTYP (data.js). */
...
const product = {
  ...
  build(size, variant, clipPlane) {
    ...
    const A = createAssembly({
      name: 'K-Aqua_hand-welding-machine-20-63'.replace(/-/g, '_'), materials: ['steel', 'toolBlack'], seed: 241, clipPlane,
    });

        ...
        if (call.name === 'replace_file_content' || call.name === 'multi_replace_file_content') {
           ...
           if (args.TargetFile && args.TargetFile.includes('uk.json')) {
               ...
               for (let content of contentsToParse) {
                   ...
                   // content starts with " and ends with " and has literal newlines inside.
                   // We want to extract the object values for root keys!
                   // But since it's a string with `\"`, we can unescape `\"` to `"` and `\\\\` to `\\`
                   ...
                   // Now content is just a normal string like:
                   //   },
                   //   "aboutx": { ... }

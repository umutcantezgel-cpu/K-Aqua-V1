...
m_res = get_missing(de['resources'], es.get('resources', {}))
m_kon = get_missing(de['kontaktBlocks'], es.get('kontaktBlocks', {}))

with open('resources_missing.json', 'w') as f: json.dump(m_res, f, indent=2, ensure_ascii=False)
with open('kontaktBlocks_missing.json', 'w') as f: json.dump(m_kon, f, indent=2, ensure_ascii=False)
